...
const validationSchema = toTypedSchema(
  z.object({
    ...
    photoUrl: z
      .string()
      .url("Please provide a valid image URL link")
      .or(z.literal(""))
      .nullable()
      .optional(),
  }),
...
<template>
  ...
  >
    <div class="mb-6">
      <h2 class="text-xl font-bold tracking-wide">Register New Director</h2>
    ...
    <form @submit.prevent="onSubmit" class="space-y-5">
      ...
      <div class="flex flex-col gap-1.5">
        <AdminImageUploader
          v-model="photoUrl"
          label="Profile Portrait (Optional)"
        />
      ...
      <div class="pt-2">
        ...
        >
          {{ isSubmitting ? "Saving Metadata..." : "Save Director Profile" }}
        </button>
      </div>
    </form>
  </div>
