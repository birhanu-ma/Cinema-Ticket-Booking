...
ALTER TABLE ONLY public.bookmarks
    ADD CONSTRAINT bookmarks_user_id_schedule_id_key UNIQUE (user_id, schedule_id);
ALTER TABLE ONLY public.cinema_halls
    ADD CONSTRAINT cinema_halls_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.schedule_seats
    ADD CONSTRAINT schedule_seats_schedule_id_seat_id_key UNIQUE (schedule_id, seat_id);
ALTER TABLE ONLY public.schedules
    ADD CONSTRAINT schedules_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.seats
    ADD CONSTRAINT seats_hall_id_seat_number_row_name_key UNIQUE (hall_id, seat_number, row_name);
ALTER TABLE ONLY public.seats
...
ALTER TABLE ONLY public.bookmarks
    ADD CONSTRAINT bookmarks_schedule_id_fkey FOREIGN KEY (schedule_id) REFERENCES public.schedules(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.bookmarks
    ADD CONSTRAINT bookmarks_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.cinema_halls
    ADD CONSTRAINT cinema_halls_cinema_id_fkey FOREIGN KEY (cinema_id) REFERENCES public.cinemas(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.movie_genres
...
ALTER TABLE ONLY public.schedule_seats
    ADD CONSTRAINT schedule_seats_schedule_id_fkey FOREIGN KEY (schedule_id) REFERENCES public.schedules(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.schedule_seats
    ADD CONSTRAINT schedule_seats_seat_id_fkey FOREIGN KEY (seat_id) REFERENCES public.seats(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.schedules
    ADD CONSTRAINT schedules_hall_id_fkey FOREIGN KEY (hall_id) REFERENCES public.cinema_halls(id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public.schedules
    ADD CONSTRAINT schedules_movies_id_fkey FOREIGN KEY (movies_id) REFERENCES public.movies(id) ON DELETE SET NULL;
ALTER TABLE ONLY public.seats
    ADD CONSTRAINT seats_hall_id_fkey FOREIGN KEY (hall_id) REFERENCES public.cinema_halls(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public.tickets
    ADD CONSTRAINT tickets_schedule_id_fkey FOREIGN KEY (schedule_id) REFERENCES public.schedules(id) ON DELETE SET NULL;
ALTER TABLE ONLY public.tickets
